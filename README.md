# tryhackme-writeups
![IMAGE](https://github.com/eohTran/tryhackme-writeups/blob/main/tryhackmelogo.png?raw=true)

## Description:

A repository documenting my progress, findings, and lessons learned while completing TryHackMe challenges, along with my efforts to improve my write-up skills. Some of the rooms in this writup are comprised of previous writeup from over the year before June of this repository. I previously did short-form writeups on a google doc before converting to github to make my work more transparant.


## Config:

Some TryHackMe labs will require that you connect to their lab machine via your own machine. TryHackMe offers two ways to connect to their labs.
...
|[Ignite](https://github.com/eohTran/tryhackme-writeups/blob/main/tryhackme-rooms/ignite/ignite.md)| easy | in progress |
## Resources:
